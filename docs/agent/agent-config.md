...
3. fallback agent config: [`../../src/skiller/infrastructure/agent/config.json`](../../src/skiller/infrastructure/agent/config.json)

Current fallback values in [`../../src/skiller/infrastructure/agent/config.json`](../../src/skiller/infrastructure/agent/config.json):
...
1. environment variables
2. `~/.skiller/settings/agent.json`
3. fallback shell config: [`../../src/skiller/infrastructure/tools/shell/config.json`](../../src/skiller/infrastructure/tools/shell/config.json)
...
1. environment variables
2. `~/.skiller/settings/agent.json`
3. fallback llm config: [`../../src/skiller/infrastructure/llm/config.json`](../../src/skiller/infrastructure/llm/config.json)
...
1. environment variables
2. `~/.skiller/settings/agent.json`
3. runtime defaults in [`../../src/skiller/infrastructure/config/settings_model.py`](../../src/skiller/infrastructure/config/settings_model.py)
