...
class HandleWebhookUseCase:
    ...
    def execute(self, webhook: str, key: str, payload: dict[str, Any], *, dedup_key: str) -> HandleWebhookResult:
        ...
        final_dedup_key = dedup_key or hashlib.sha256(
            f"{webhook}|{key}|{canonical_payload}".encode("utf-8")
        ).hexdigest()
