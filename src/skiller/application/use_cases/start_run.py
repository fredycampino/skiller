...
class StartRunUseCase:
    ...
    def execute(self, skill_ref: str, inputs: dict[str, Any], *, skill_source: str = SkillSource.INTERNAL.value) -> str:
        ...
        return self.store.create_run(skill_source, skill_ref, skill_snapshot, context)
